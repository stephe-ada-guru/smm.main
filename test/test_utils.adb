...
--  see spec
--
--  Copyright (C) 2007 - 2009, 2015 - 2016, 2018, 2019, 2022, 2025 Stephen Leake.  All Rights Reserved.
--
...
package body Test_Utils is
   ...
   is begin
      return Result : SMM.Metadata.Frame_Lists.List do
         Result.Append (Item);
      end return;
   end "+";
   ...
   is begin
      return Result : SMM.Metadata.Frame_Lists.List := List do
         Result.Append (Item);
      end return;
   end "&";
