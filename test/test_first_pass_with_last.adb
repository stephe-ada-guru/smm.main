...
--  See spec
--
--  Copyright (C) 2007 - 2009, 2011, 2012, 2015, 2016 Stephen Leake.  All Rights Reserved.
--
...
package body Test_First_Pass_With_Last is
   ...
   is
      pragma Unreferenced (T);
   begin
      return new String'("../../test/test_first_pass_with_last.adb");
   end Name;
