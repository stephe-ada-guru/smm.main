...
package body SMM.Database.Test is
   ...
   begin
      ...
      DB.Insert
        (4, "artist_2/album_1/1 - song_1.mp3", "vocal", "artist 2", "album 1", "album_artist 2", "composer 2",
         2000, "1 - song_1", 1);
      DB.Insert (5, "artist_2/album_1/2 - song_2.mp3", "vocal", "artist 2", "album 1", "album_artist 2", "composer 2",
                 2000, "2 - song_2", 2);
      DB.Insert (6, "artist_2/album_1/3 - song_3.mp3", "vocal", "artist 2", "album 1", "album_artist 2", "composer 2",
                 2000, "3 - song_3", 3);
   end Set_Up_Case;
