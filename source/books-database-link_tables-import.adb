...
is
   ...
   First_Column_Name : constant String := Table_Names'Image (T.Link_Names (Link_Index'First));
   Last_Column_Name  : constant String := Table_Names'Image (T.Link_Names (Link_Index'Last));
   ...
   is
      ...
      I : constant Cursor := ID_Maps (T.Link_Names (Link_Index)).Find (Old_IDs (Link_Index));
   begin
      if I = ID_Map_Pkg.No_Element then
         Put_Line
           (Table_Name & Integer'Image (Old_IDs (Old_IDs'First)) & Integer'Image (Old_IDs (Old_IDs'Last)) &
   ...
   loop
      begin
         declare
            ...
            New_First_ID : constant Integer := Checked_Find (Link_Index'First, (Old_First_ID, Old_Last_ID));
            New_Last_ID  : constant Integer := Checked_Find (Link_Index'Last, (Old_First_ID, Old_Last_ID));
         begin
