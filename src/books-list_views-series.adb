...
package body Books.List_Views.Series is

   procedure Gtk_New (Series_View : out Gtk_List_View)
   is begin
      Gtk.Clist.Gtk_New
        (Gtk.Clist.Gtk_Clist (Series_View),
         Columns => 2,
         Titles  =>
         ...
         List_View.Insert
           (0,
            (1 => New_String (Image (ID)),
             2 => New_String (Table.Field (Data_Tables.Series.Title_Index))));
      else
